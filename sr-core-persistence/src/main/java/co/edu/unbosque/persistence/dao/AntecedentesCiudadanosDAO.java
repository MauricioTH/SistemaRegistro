...
public interface AntecedentesCiudadanosDAO extends DataAccessObject<Antecedentesciudadanos>{
	
	public Antecedentesciudadanos findByIdentificacion(Integer code);
